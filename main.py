...
def play():
    while True:
        ...
        PLAY_TEXT = get_font(20).render("Working on it", True, "White")
...
def options():
    while True:
        ...
        OPTIONS_TEXT = get_font(20).render("Working on it", True, "Black")
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(30).render("Flappy Animal ", True, "#b68f40")
